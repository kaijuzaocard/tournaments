...
export function buildB4ABrowserPreviewBlueprint(nowMillis = Date.now()) {
  ...
  const events = [
    ...
    { id: 'b4a-preview-e5-ranked-waitlist', title: 'E5 Ranked Waitlist', date: dates[4], capacity: 2, preRegistration: { schemaVersion: 2, enabled: true, waitlistEnabled: true, capacity: 2, deadline: null } },
  ...
  return Object.freeze({
    ...
    scenarios: Object.freeze({
      ...
      [events[4].id]: { active: 2, waitlisted: 3 },
